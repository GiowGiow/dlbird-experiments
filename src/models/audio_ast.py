...
class AudioAST(nn.Module):
    ...
    def __init__(
        ...
        try:
            ...
            warnings.warn(f"Failed to load pretrained AST: {e}. Using random initialization.")
    ...
    def forward(self, spectrograms: torch.Tensor) -> torch.Tensor:
        ...
        if current_length < max_length:
            ...
            spectrograms = torch.nn.functional.pad(spectrograms, (0, pad_size), mode='constant', value=0)
