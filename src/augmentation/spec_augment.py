...
class FrequencyMasking:
    ...
    def __init__(self, freq_mask_param: int = 15, num_masks: int = 1, mask_value: float = 0.0):
...
class TimeMasking:
    ...
    def __init__(self, time_mask_param: int = 35, num_masks: int = 1, mask_value: float = 0.0):
...
if __name__ == '__main__':
    ...
    print(f"Masked values: {masked_count}/{total_count} ({100*masked_count/total_count:.2f}%)")
