...
class TestFocalLossForwardPass:
    ...
    def test_focal_weight_behavior(self):
        ...
        assert loss_easy < 0.1, (
            f"Easy example loss should be near 0, got {loss_easy.item()}"
        )
...
class TestFocalLossNumericalStability:
    ...
    def test_all_correct_predictions(self):
        ...
        assert (losses < 0.01).all(), (
            "Losses should be near 0 for confident correct predictions"
        )
